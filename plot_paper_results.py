...
if arg == 'halfcheetah' or arg == 'all':
    ...
    for norm in norms:
        ...
        plot_curves(methods, names, omegas, norm, line_colors, f'experiment_results/halfcheetah_{norm}', 'halfcheetah', per_update_qualia_limits, NUM_TRIALS=300, NUM_BINS=100)
...
if arg == 'cartpole' or arg == 'all':
    ...
    for norm in norms:
        if norm == "norm":
            ...
            plot_curves(methods, names, omegas, norm, line_colors, 'experiment_results/cartpole_norm', 'cartpole', qe_lims, NUM_TRIALS=300, NUM_BINS=100)
...
if arg == 'pong' or arg == 'all':
    ...
    for norm in norms:
        ...
        if norm == "norm":
            ...
            plot_curves(methods, names, omegas, norm, line_colors, 'experiment_results/pong_norm', 'pong', qe_lims, NUM_TRIALS=100, NUM_BINS=100)
